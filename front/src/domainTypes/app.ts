...
import type { Tournament, Team, Player, Match, StandingRow, StudentAssessment, PlayerAttendanceRecord } from "./sports";
...
export type TabKey = "dashboard" | "adult-dashboard" | "sports" | "coaches" | "referees" | "uniforms" | "debts" | "sales-estimate" | "income-statement" | "daily-operation" | "attendance" | "billing" | "expenses" | "students" | "guardians" | "sites" | "users" | "invoices" | "historical" | "discrepancies";
