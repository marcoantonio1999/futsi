...
import { AutomaticFaceComparisonCard } from "../evidence/AutomaticAttendanceComparisonCard";
import { EvidenceImage } from "../evidence/AutomaticAttendanceEvidence";
import { formatBytes, formatDuration, formatSpeed, similarityPercent } from "../format";
import type { AutomaticAttendanceJob } from "../model";

export function AutomaticJobResultsModal({ job, token, elapsedSeconds, onClose }: { job: AutomaticAttendanceJob; token: string; elapsedSeconds: number | null; onClose: () => void }) {
          ...
          <div className="rounded-md border border-zinc-200 p-3 dark:border-zinc-800">
            <div className="flex flex-wrap items-center justify-between gap-2 text-sm">
              ...
              <span className="text-zinc-500 dark:text-zinc-400">
                {isProcessing ? "En proceso" : "Finalizado"}{elapsedSeconds != null ? ` - ${formatDuration(elapsedSeconds)}` : ""}
              </span>
            </div>
