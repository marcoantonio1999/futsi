...
export type VoiceDashboardSection = "summary" | "bookings" | "calls" | "whatsapp" | "weekly-stats" | "availability" | "settings" | "collections" | "templates" | "veronica" | "bulk-veronica" | "bulk-academy" | "connections";
