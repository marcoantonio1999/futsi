...
export default function VeronicaPortal({ token, name, onLogout }: { token: string; name: string; onLogout: () => void }) {
  const [section, setSection] = useState<'manual' | 'bulk'>('manual');
