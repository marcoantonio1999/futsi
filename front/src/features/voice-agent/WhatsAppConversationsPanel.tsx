...
function ConversationDetail({ conversation: c, assignees, body, onBody, onBack, onSave, onResolve, onSend }: {
  ...
  return <div className="comm-chat">
    ...
    <div className="comm-chat-context">
      <p className="comm-muted">Canal: {c.channel_label || c.business_address?.replace("whatsapp:", "").replace("meta:", "ID ") || "Sin número identificado"} · {c.channel_site_name || c.site_name || "Sin sede vinculada"}</p>
