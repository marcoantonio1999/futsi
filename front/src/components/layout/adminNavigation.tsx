...
export function defaultSectionsByRole(tabs: Array<{ key: TabKey }>): Record<Role, TabKey[]> {
  return {
    ...
    site_coordinator: ["dashboard", "sports", "tournaments", "attendance", "billing", "debts", "expenses", "students", "guardians", "uniforms"],
    cashier: ["billing", "debts"],
    coach: ["dashboard", "sports", "tournaments", "attendance", "students"],
    guardian: ["sports"],
